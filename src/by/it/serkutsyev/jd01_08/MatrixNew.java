...
class MatrixNew extends Var {

    public final double [][] value;

    public MatrixNew(double [][] value) {
        this.value = Arrays.copyOf(value,value.length);
    }

    public MatrixNew(MatrixNew matrix) {
        this.value = matrix.value;
    }

    public MatrixNew(String strMatrix) {
    ...
    public Var add(Var other) {
        if (other instanceof Scalar otherScalar)
        {
            ...
            return new MatrixNew(arrayCopy);
        }
        if (other instanceof MatrixNew otherMatrix)
        {
            double [][] arrayCopy = Arrays.copyOf(this.value,value.length);
    ...
    public Var mul(Var other) {
        ...
        if (other instanceof MatrixNew otherMatrix)
        {
            ...
            return new MatrixNew(matrixResult);
        }
