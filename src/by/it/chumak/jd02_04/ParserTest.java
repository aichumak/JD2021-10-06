...
import by.it.chumak.calc.service.Logger;
...
public class ParserTest {
    ...
    public void scalarOperationA1() throws CalcException {
        expression = "A=2+5.3";
        double expected = 7.3;
        scalar = parser.evaluate(resourceManager, logger, expression, varRepository);
    ...
    public void vectorOperationB3() throws CalcException {
        expression = "D=10";
        vector = parser.evaluate(resourceManager, logger, expression, varRepository);
    ...
    public void matrixOperationC1() throws CalcException {
        ...
        matrix = parser.evaluate(resourceManager, logger, expression, varRepository);
